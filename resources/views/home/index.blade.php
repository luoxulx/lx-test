            ...
            <div class="slider">
                <div class="callbacks_container">
                    <ul class="rslides" id="slider">
                        <li> <img src="https://p.w3layouts.com/demos/voguish/web/images/1.jpg" class="img-responsive" alt="" />
                            <div class="caption">
                        ...
                        <li> <img src="https://p.w3layouts.com/demos/voguish/web/images/4.jpg" class="img-responsive" alt="" />
                            <div class="caption">
                        ...
                        <li> <img src="https://p.w3layouts.com/demos/voguish/web/images/5.jpg" class="img-responsive" alt="" />
                            <div class="caption">
                        ...
                        <li> <img src="https://p.w3layouts.com/demos/voguish/web/images/6.jpg" class="img-responsive" alt="" />
                            <div class="caption">
    ...
    <div class="nam-matis">
        <div class="nam-matis-top">
            <div class="col-md-6 nam-matis-1">
                <a href="single.html"><img src="https://p.w3layouts.com/demos/voguish/web/images/5.jpg" class="img-responsive" alt="" /></a>
            ...
            <div class="col-md-6 nam-matis-1">
                <a href=""><img src="https://p.w3layouts.com/demos/voguish/web/images/6.jpg" class="img-responsive" alt="" /></a>
        ...
        <div class="nam-matis-top">
            <div class="col-md-6 nam-matis-1">
                <a href="single.html"><img src="https://p.w3layouts.com/demos/voguish/web/images/4.jpg" class="img-responsive" alt="" /></a>
                <h3><a href="single.html">Suspendisse a pellentesque dui</a></h3>
                <p>Etiam ullamcorper. Suspendisse a pellentesque dui, non felis. Maecenas malesuada elit lectus felis, malesuada ultricies. Curabitur et ligula.</p>
            </div>
            <div class="col-md-6 nam-matis-1">
                <a href="single.html"><img src="https://p.w3layouts.com/demos/voguish/web/images/1.jpg" class="img-responsive" alt="" /></a>
                <h3><a href="single.html">Suspendisse a pellentesque dui</a></h3>
                <p>Etiam ullamcorper. Suspendisse a pellentesque dui, non felis. Maecenas malesuada elit lectus felis, malesuada ultricies. Curabitur et ligula.</p>
            </div>
            <div class="clearfix">
